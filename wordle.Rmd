...
Time to actually play! I did have to use some help from online for this function, but did the bulk myself. Primarily, I needed help with the evaluate part of the function. I am not entirely sure how the wordlength and rep() part of the evaluate function works.  

This function is used in the main game to evaluate guesses. I needed to use the wordle function online to find out how to do the yellow section especially. I added the rep() part of the function as a result, but I'm not sure it's necessary! 
...
This is the main function used to play wordle that uses the above function # finish this
